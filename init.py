...
from utils.概率和行业 import build_full_market_mapping, enrich_ladder_data_from_db
...
df_today = df_enriched[df_enriched['date'] == target_date]


# 打印全部记录（确保显示完整）
print(df_enriched[['thscode', 'name', 'date','board_num', 'concept', 'industry']].to_string(index=False))
